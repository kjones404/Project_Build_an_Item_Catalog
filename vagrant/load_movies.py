...
movieItem1 = MovieItem(title="Guardians of the Galaxy ", year="2014",
...
movieItem1 = MovieItem(title="The Princess Bride", year="1987",
...
movieItem1 = MovieItem(title="Office Space", year="1999",
...
movieItem1 = MovieItem(title="Ghostbusters", year="1984",
...
# collection for Bob
collection1 = Collection(name="Bob")
...
movieItem1 = MovieItem(title="Up", year="2009",
...
movieItem1 = MovieItem(title="Brave", year="2012",
                     img="https://image.tmdb.org/t/p/w342/qhABv2d4NZLhsOOA4iBFM4rfuJC.jpg", description="Brave is set in the mystical Scottish Highlands, where Mérida is the princess of a kingdom ruled by King Fergus and Queen Elinor. An unruly daughter and an accomplished archer, Mérida one day defies a sacred custom of the land and inadvertently brings turmoil to the kingdom. In an attempt to set things right, Mérida seeks out an eccentric old Wise Woman and is granted an ill-fated wish. Also figuring into Mérida’s quest — and serving as comic relief — are the kingdom’s three lords: the enormous Lord MacGuffin, the surly Lord Macintosh, and the disagreeable Lord Dingwall.", collection=collection1)

session.add(movieItem3)
session.commit()

movieItem1 = MovieItem(title="Ratatouille", year="2007",
...
movieItem1 = MovieItem(title="Finding Nemo", year="2003",
...
movieItem1 = MovieItem(title="Piper", year="2016",
...
movieItem1 = MovieItem(title="Heat", year="1995",
...
movieItem1 = MovieItem(title="Howard the Duck", year="1986",
...
movieItem1 = MovieItem(title="The Last Dragon", year="1985",
...
movieItem1 = MovieItem(title="The Golden Child", year="1986",
...
movieItem1 = MovieItem(title="Spaceballs", year="1987",
