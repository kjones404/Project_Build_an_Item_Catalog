...
def fred():
    ...
    movieItem1 = MovieItem(title="The Fifth Element",
                           year="1997",
                           img="https://image.tmdb.org/t/p/w342/zaFa1NRZEnFgRTv5OVXkNIZO78O.jpg",
    ...
    movieItem2 = MovieItem(title="John Wick",
                           year="2014",
                           img="https://image.tmdb.org/t/p/w342/5vHssUeVe25bMrof1HyaPyWgaP.jpg",
    ...
    movieItem3 = MovieItem(title="Guardians of the Galaxy ",
                           year="2014",
                            img="https://image.tmdb.org/t/p/w342/y31QB9kn3XSudA15tV7UWQ9XLuW.jpg",
    ...
    movieItem4 = MovieItem(title="The Princess Bride",
                           year="1987",
                           img="https://image.tmdb.org/t/p/w342/gpxjoE0yvRwIhFEJgNArtKtaN7S.jpg",
    ...
    movieItem5 = MovieItem(title="Office Space",
                           year="1999",
                           img="https://image.tmdb.org/t/p/w342/iO9aZzrfmMvm3IqkFiQyuuUMLh2.jpg",
    ...
    movieItem6 = MovieItem(title="Ghostbusters",
                           year="1984",
                           img="https://image.tmdb.org/t/p/w342/3FS3oBdorgczgfCkFi2u8ZTFfpS.jpg",
...
def bob():
    ...
    movieItem21 = MovieItem(title="WALL-E",
                            year="2008",
                            img="https://image.tmdb.org/t/p/w342/9cJETuLMc6R0bTWRA5i7ctY9bxk.jpg",
    ...
    movieItem22 = MovieItem(title="Up",
                            year="2009",
                            img="https://image.tmdb.org/t/p/w342/nk11pvocdb5zbFhX5oq5YiLPYMo.jpg",
    ...
    movieItem23 = MovieItem(title="Brave",
                            year="2012",
                            img="https://image.tmdb.org/t/p/w342/qhABv2d4NZLhsOOA4iBFM4rfuJC.jpg",
    ...
    movieItem24 = MovieItem(title="Ratatouille",
                            year="2007",
                            img="https://image.tmdb.org/t/p/w342/y8y6Fv0k068OnHBZtu949A1t6pj.jpg",
    ...
    movieItem25 = MovieItem(title="Finding Nemo",
                            year="2003",
                            img="https://image.tmdb.org/t/p/w342/syPWyeeqzTQIxjIUaIFI7d0TyEY.jpg",
    ...
    movieItem26 = MovieItem(title="Piper",
                            year="2016",
                            img="https://image.tmdb.org/t/p/w342/jLRllZsubY8UWpeMyDLVXdRyEWi.jpg",
